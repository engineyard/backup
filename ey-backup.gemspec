...
Gem::Specification.new do |gem|
  ...
  gem.description = <<-EOS.gsub(/\s+/, ' ').strip
    ***** Modified from upstream to include engineyard storage and interim backup functionality for mysql *********
  ...
  gem.add_dependency 'hipchat', '= 0.9.0'
  ...
  gem.add_dependency 'net-scp', '= 1.1.1'
